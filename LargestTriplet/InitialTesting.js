describe("linkedList", function() {
    ...
    it("The linked list should have a Node class that can take a value argument and have defined next and previous to be undefined.", function() {
        var node = new Node("Testing");
        Test.assertEquals(node.value, "Testing");
        Test.assertEquals(node.next, undefined);
        Test.assertEquals(node.previous, undefined);
    });
